...
class MainWindow(QMainWindow):
    ...
    def setupUi(self):
        ...
        self.menuCreate_XML_file_from_xlsx_file = QtWidgets.QMenu(self.menuActions)
        ...
        self.menuSend_values_to_GUS = QtWidgets.QMenu(self.menuActions)
        ...
        self.actionDG_2 = QtWidgets.QAction(self)
        self.actionDG_2.setObjectName("actionDG_2")
        self.action_C_2 = QtWidgets.QAction(self)
        self.action_C_2.setObjectName("action_C_2")
        self.actionDG_1 = QtWidgets.QAction(self)
        self.actionDG_1.setObjectName("actionDG_1")
        self.actionSP = QtWidgets.QAction(self)
        self.actionSP.setObjectName("actionSP")
        self.actionF_2 = QtWidgets.QAction(self)
        self.actionF_2.setObjectName("actionF_2")
        self.actionDG_01 = QtWidgets.QAction(self)
        self.actionDG_01.setObjectName("actionDG_01")
        ...
        self.menuCreate_XML_file_from_xlsx_file.addAction(self.actionMAZ_KRH)
        self.menuCreate_XML_file_from_xlsx_file.addAction(self.actionMPZ_KRH)
        ...
        self.menuCreate_WB_for_specyfic_GUS_forms.addAction(self.actionDG_2)
        self.menuCreate_WB_for_specyfic_GUS_forms.addAction(self.actionRF_01)
        self.menuActions.addAction(self.actionSort_Values)
        self.menuActions.addAction(self.menuCreate_XML_file_from_xlsx_file.menuAction())
        self.menuActions.addAction(self.menuCreate_WB_for_specyfic_GUS_forms.menuAction())
        self.menuActions.addAction(self.menuSend_values_to_GUS.menuAction())
    ...
    def retranslateUi(self):
        ...
        self.menuCreate_XML_file_from_xlsx_file.setTitle(_translate("MainWindow", "Create XML file from .xlsx file"))
        self.menuCreate_WB_for_specyfic_GUS_forms.setTitle(_translate("MainWindow", "Create WB  for specyfic GUS forms"))
        self.menuSend_values_to_GUS.setTitle(_translate("MainWindow", "Send values to GUS"))
        ...
        self.actionDG_2.setText(_translate("MainWindow", "DG-1"))
        self.action_C_2.setText(_translate("MainWindow", "C-01"))
        self.actionDG_1.setText(_translate("MainWindow", "DG-1"))
        self.actionSP.setText(_translate("MainWindow", "SP"))
        self.actionF_2.setText(_translate("MainWindow", "F-01"))
        self.actionDG_01.setText(_translate("MainWindow", "RF-01"))
